   $(".indent_modal_btn").on("click",function () {
    ...
    $(".indent-card-pending").on("click",function () {
        if($(this).attr("data-type") === "3") {
            $("#approve_indent_btn_pending").removeClass("hidden");
        } else {
            $("#approve_indent_btn_pending").addClass("hidden");
        }

        $("#indent_details_modal_pending").modal("show");
    });
    ...
    function approveIndentPending() {
        $("#indent_details_modal_pending").modal("hide");
