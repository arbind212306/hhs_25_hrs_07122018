...
<hr />
 ...
 <?php
  ...
  <div class="row1"><div class="col-md-4"><div class="form-group"> <button  id="find">Find</button></div></div></div>
...
if($('#todate').val() ==''){
    ...
    url: '<?php echo $this->Url->build(['controller'=>'UserRoster','action'=>'viewteamroster']); ?>',
    dataType: "json",
    type: 'POST',
							...
							afterEditCell: function(rowid, cellname, value, iRow, iCol) {
								...
								$('#' +iRow+ '_' + cellname).on('change', function() {
									...
									jsonStr = JSON.stringify(obj);*/
									 ...
									 ColumnToSave.push({"empid":empid,"shift":this.value,"rdate":rdate});
 ...
 var states = { '1': 'Alabama', '2': 'California', '3': 'Florida', 
  ...
  return states;
   ...
   <input type="hidden" name="task"  value ="saveteamroster" />
   <?php
   /* 
    echo $this->Form->button(__('Set Roster'),['id'=>'setroster']);
    echo $this->Form->end();
	*/
?>
</div>
