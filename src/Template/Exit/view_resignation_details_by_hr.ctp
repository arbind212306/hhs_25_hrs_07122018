            ...
            <div class="box box-primary">
                        ...
                        <?= $this->Form->create(null, ['url' => false]); ?>
                          ...
                          <div class="box-body pad">
                            ...
                            echo $data['resignation_text']; } ?></textarea>
                            </div>
                ...
                <div class="form-group">
                        ...
                        <div class="box-body pad">
                            ...
                            <textarea class="textarea dis12" id="get-appraiser-txt" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" readonly>
                                <?php if(!empty($data['appraiser_comments'])){echo $data['appraiser_comments'];} ?></textarea>
                            </div>
                        <hr style="color: #00c0ef;"> 
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="col-sm-12">
                                    <label>Reason for Resignation [Reviwer]</label>
                                </div>
                                <hr>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                  ...
                                  <div class="radio">
                                  <label>
                              <input type="radio" class="dis12" name="retain_option_by_reviewer" id="" value="2"
                                     <?php if(!empty($data) && $data['appraiser_status'] == 2||5){echo 'checked';} ?>>
                              Approve</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <label><input type="radio" class="dis12" name="retain_option_by_reviewer" id="" value="3" 
                                     <?php if(!empty($data) && $data['appraiser_status'] == 3){echo 'checked';} ?>>
                                  Retain</label>
                              </div>
                                </div>
                                <div class="form-group">
                                  ...
                                  <div class="radio">
                                  <label>
                              <input type="radio" class="dis12" name="hold_salary_by_reviewer" id="" value="1"
                                     <?php if(!empty($data) && $data['hold_salary'] == 1){echo 'checked';} ?>>
                              Yes</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <label><input type="radio" class="dis12" name="hold_salary_by_reviewer" id="" value="0" 
                                     <?php if(!empty($data) && $data['hold_salary'] == 0){echo 'checked';} ?>>
                                  No</label>
                              </div>
                                </div>
                                <div class="form-group">
                                  <label for="last working">Last working day</label>
                                  <input type="text" class="form-control dis12" id="last_working_by_reviewer"
                                  value="<?php if(!empty($separation_date)){echo $separation_date;} ?>" >
                                </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                  <label for="exit reason">Exit Reason</label>
                                  <select class="form-control dis12" id="exit-reason-by-reviewer">
                                        <option value="">select reason</option>
                                    <?php if(!empty($exit_reason)){ foreach($exit_reason as $r) {?>    
                                        <option value="<?php echo $r['id']; ?>"<?php 
                                        if(!empty($data) && $data['exit_reason'] == $r['id']){
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="radio">
                                  <label>
                              <input type="radio" name="serve_notice_by_reviewer" id="" class="dis12" value="1"
                              <?php if(!empty($data) && $data['serve_notice_period'] == 1){echo 'checked';} ?> >Yes</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <label><input type="radio" name="serve_notice_by_reviewer" class="dis12" id="" value="0"
                              <?php if(!empty($data) && $data['serve_notice_period'] == 0){echo 'checked';} ?> >No</label>
                              </div>
                                </div>
                                <div class="form-group">
                                  ...
                                  <div class="radio">
                                  <label>
                                      <input type="radio" name="waiver_notice_pay_by_reviewer" class="dis12" id="" value="1"
                              <?php if(!empty($data) && $data['waiver_notice_pay'] == 1){echo 'checked';} ?>>Notice period to be waived off</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <label><input type="radio" name="waiver_notice_pay_by_reviewer" class="dis12" id="" value="0" 
                              <?php if(!empty($data) && $data['waiver_notice_pay'] == 0){echo 'checked';} ?> >Recovery for notice period not served</label>
                              </div>
                                </div>
                                </div>
                        ...
                        <div class="box-body pad">
                            ...
                            <textarea class="textarea dis12" id="get-reviwer-comment" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $data['reviwer_comment']; ?></textarea>
                            </div>
                        <hr style="color: #00c0ef;"> 
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="col-sm-12">
                                    <label>Reason for Resignation [HR Manager]</label>
                                </div>
                                <hr>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                  ...
                                  <div class="radio">
                                  <label>
                              <input type="radio" class="" name="retain_option_hr" id="" value="2"
                                     <?php if(!empty($data) && $data['appraiser_status'] == 2||5){echo 'checked';} ?>>
                              Approve</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <label><input type="radio" class="" name="retain_option_by_hr" id="" value="3" 
                                     <?php if(!empty($data) && $data['appraiser_status'] == 3){echo 'checked';} ?>>
                                  Retain</label>
                              </div>
                                </div>
                                <div class="form-group">
                                  ...
                                  <div class="radio">
                                  <label>
                              <input type="radio" class="" name="hold_salary_by_hr" id="" value="1"
                                     <?php if(!empty($data) && $data['hold_salary'] == 1){echo 'checked';} ?>>
                              Yes</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <label><input type="radio" class="" name="hold_salary_by_hr" id="" value="0" 
                                     <?php if(!empty($data) && $data['hold_salary'] == 0){echo 'checked';} ?>>
                                  No</label>
                              </div>
                                </div>
                                <div class="form-group">
                                  <label for="last working">Last working day</label>
                                  <input type="text" class="form-control" id="last_working_by_hr"
                                  value="<?php if(!empty($separation_date)){echo $separation_date;} ?>" >
                                </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                  <label for="exit reason">Exit Reason</label>
                                  <select class="form-control" id="exit-reason-by-hr">
                                        <option value="">select reason</option>
                                    <?php if(!empty($exit_reason)){ foreach($exit_reason as $r) {?>    
                                        <option value="<?php echo $r['id']; ?>"<?php 
                                        if(!empty($data) && $data['exit_reason'] == $r['id']){
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="radio">
                                  <label>
                              <input type="radio" name="serve_notice_by_hr" id="" class="" value="1"
                              <?php if(!empty($data) && $data['serve_notice_period'] == 1){echo 'checked';} ?> >Yes</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <label><input type="radio" name="serve_notice_by_hr" class="" id="" value="0"
                              <?php if(!empty($data) && $data['serve_notice_period'] == 0){echo 'checked';} ?> >No</label>
                              </div>
                                </div>
                                <div class="form-group">
                                  ...
                                  <div class="radio">
                                  <label>
                                      <input type="radio" name="waiver_notice_pay_by_hr" class="" id="" value="1"
                              <?php if(!empty($data) && $data['waiver_notice_pay'] == 1){echo 'checked';} ?>>Notice period to be waived off</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <label><input type="radio" name="waiver_notice_pay_by_hr" class="" id="" value="0" 
                              <?php if(!empty($data) && $data['waiver_notice_pay'] == 0){echo 'checked';} ?> >Recovery for notice period not served</label>
                              </div>
                                </div>
                                </div>
                        ...
                        <div class="box-body pad">
                            ...
                            <textarea class="textarea" id="get-hr-comment" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                            </div>
                      <div class="box-footer pull-right">
                            <button type="button" id="btn-Hr-Manager" class="btn btn-primary">Submit</button>
