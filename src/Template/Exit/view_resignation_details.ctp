            ...
            <div class="box box-primary">
                ...
                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="col-sm-6">
                                  ...
                                  <div class="radio">
                                  <label>
                              <input type="radio" name="retain_option" id="" value="2">Approve</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <label><input type="radio" name="retain_option" id="" value="3" >Retain</label>
                              </div>
                                </div>
                                <div class="form-group">
                              ...
                              <label><input type="radio" name="hold_salary" id="" value="0" >No</label>
                              </div>
                                </div>
                                <div class="form-group">
                                  <label for="last working">Last working day</label>
                                  <input type="text" class="form-control" id="last_working"
                                ...
                                <div class="col-sm-6">
                                  ...
                                  <select class="form-control" id="exit-reason-supervisor">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="radio">
                                  <label>
                              <input type="radio" name="serve_notice" id="" value="1"
                              <?php if(!empty($data) && $data['serve_notice_period'] == 1){echo 'checked';} ?> >Yes</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <label><input type="radio" name="serve_notice" id="" value="0"
                              <?php if(!empty($data) && $data['serve_notice_period'] == 0){echo 'checked';} ?> >No</label>
                              </div>
                                </div>
                                <div class="form-group">
                                  ...
                                  <div class="radio">
                                  <label>
                              <input type="radio" name="waiver_notice_pay" id="" value="1"
                              <?php if(!empty($data) && $data['waiver_notice_pay'] == 1){echo 'checked';} ?>>Notice period to be waived off</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <label><input type="radio" name="waiver_notice_pay" id="" value="0" 
                        ...
                        <div class="box-body pad">
                            ...
                            <textarea class="textarea" id="get-appraiser-txt" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" readonly></textarea>
                            </div>
                      <div class="box-footer pull-right">
                            <button type="button" id="btn-approveResignSupervisior" class="btn btn-primary">Submit</button>
