...
?>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="exit reason">Reason for Termination</label>
                                <select class="form-control" name="exit_reason_reviewer" id="absconding-reason">
                                    <option value="">--select--</option>
                                    <?php
                                    if (!empty($absconding_reason)) {
                                        foreach ($absconding_reason as $value) {
                        ...
                        <div class="col-sm-6">
                            <div class="box-body pad">
                                ...
                                <textarea class="form-control" rows="7" id="reviewer-comment-abscond"></textarea>
                            </div>
                        </div>

                    </div>
                    <div class="box-footer pull-right">
                        <button type="button" id="btn-absconding-reviewer" class="btn btn-primary">Submit</button>
